...
export type TZUpsertUser = z.infer<ReturnType<typeof zUpsertUser>>
export const zUpsertUser = (options?: { except?: number }) => {
  return z.object({
    id: z.number().nullish(),
    name: zName(),
    email: zEmail({
...
export const upsertUser = async (event: H3Event, v?: { input?: TZUpsertUser }) => {
